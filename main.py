"""This part make a character creation."""
...
class Character:
    ...
    def attack(self) -> str:
        value_attack = DEFAULT_ATTACK + random.randint(*self.RANGE_VALUE_ATTACK)
        return f'{self.name} нанёс противнику урон, равный {value_attack}'
        
        
    def defence(self):
        value_defence = DEFAULT_DEFENCE + random.randint(*self.RANGE_VALUE_DEFENCE)
...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        ...
        if selected_class not in game_classes.keys():
            print('dinahoi')
            return
